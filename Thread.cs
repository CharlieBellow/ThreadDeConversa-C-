...
namespace ThreadConversa
{
    public class Thread
    {
        ...
        public IEnumerable<Mensagem> AdicionarMensagem(Mensagem mensagem) => AdicionaMensagemNaThread(mensagem);

        public IEnumerable<Mensagem> AdicionaMensagens (IEnumerable<Mensagem> mensagems) {
